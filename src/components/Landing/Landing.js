    ...
    <div className="Landing">
      <div className="l-block">
        ...
        <div className="lb-desc ap-desc">
          We Understand your needs, So you can do what excites you. Use our
          platform to automate everything you need to do. So that you can focus
          on creating content.
        </div>
        {/* <input onKeyUp={onEmailChange} placeholder='Your Email' className={'lb-input ' + (emailError && ' -emErr ') + (!emailValid && ' -invalid')}/>
        <div className='lb-button ap-button' onClick={validateEmail}>Save</div> */}
      </div>
      <div className="l-block">
