...
export default ()=> {
  ...
  return (
    <div className='Footer'>
      <div className='f-bg'>
      <svg  viewBox="0 0 1324 534" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1217.57 1.54934L-16.1456 116.047L-171.003 135.296V726.904L1492.8 735.669C1426.44 516.904 1291.05 70.7827 1280.37 36.42C1269.69 2.05729 1238.71 -1.19925 1217.57 1.54934Z" fill="url(#paint0_linear)"/>
        <defs>
          <linearGradient id="paint0_linear" x1="1445.61" y1="183.61" x2="-124.105" y2="474.979" gradientUnits="userSpaceOnUse">
          ...
          <div className='f-content'>
            ...
            <div className='fc-sm'>
              ...
              <div className='fc-input'>
                <input placeholder='Your Email' value={newsLetterMail} onChange={e => setNewsLetterMail(e.target.value)}/>
                <div className='fci-button' onClick={()=> setNewsLetterMail('')}>
                  <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18.4673 0.412598L0.796509 8.84038L5.55404 11.4227L10.9912 8.02452L7.45706 12.782V17.5396L10.9912 13.5976L14.2535 15.6366L18.4673 0.412598Z" fill="white"/>
                  </svg>
                </div>
              </div>
